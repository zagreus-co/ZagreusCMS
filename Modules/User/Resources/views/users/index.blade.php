    ...
    <div class="card">
        <div class="card-header flex justify-between">
            ...
            <div class='flex flex-nowrap'>
                <a href='{{ route("module.user.roles.index") }}' class="p-2 px-3 mr-2 btn-bs-secondary">{{__('Manage roles')}}</a>
                <a href='{{ route("module.user.users.create") }}' class="p-2 px-3 btn-success">{{__('Create user')}}</a>
            </div>
        </div>
