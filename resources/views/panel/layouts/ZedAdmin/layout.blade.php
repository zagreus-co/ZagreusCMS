...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('img/kastro.svg') }}" type="image/x-icon">
    ...
    <nav class='mobile-navbar'>
        ...
        <div>
            ...
            <div class="relative inline-block" x-data='{open: false}'>
                ...
                <div x-show="open" @click.outside="open = false" class="dropdown-content text-left"
                    ...
                    <div class='p-3 text-sm text-gray-500 border-b border-gray-100 space-y-2'>
                        {{ __('Welcome') }}
                        <span class='block text-theme-darked-primary'>{{ auth()->user()->first_name }}</span>
                    </div>
                    ...
                    <a class='flex items-center w-full p-3 text-red-500 hover:bg-red-50 transition duration-200 border-t border-gray-100'
                        ...
                        <ion-icon class='mr-1' name="log-out-outline"></ion-icon>
                        {{ __('Logout') }}
                    </a>
