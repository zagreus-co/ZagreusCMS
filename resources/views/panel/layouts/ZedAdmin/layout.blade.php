...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ panelAsset('css/app.css').'?v='.get_option('cache_id') }}" />
    ...
    <body dir="{{ app()->getLocale() == 'fa' ? 'rtl' : 'ltr' }}">
        ...
        <nav class='mobile-navbar'>
            ...
            <div>
                <livewire:panel.header-notification-area />
        ...
        <!-- ChartJS -->
        <script src="{{ asset('js/app.js').'?v='.get_option('cache_id') }}"></script>
