        ...
        <div class="w-96 px-8 py-4 mx-auto bg-white rounded-lg shadow-md mt-5">
            ...
            <div class="mt-5">
                ...
                <form action="" method="post">
                    ...
                    <div class='mt-5'>
                        <label class="text-gray-700 dark:text-gray-200" for="email">{{ __("Email address") }}</label>
                        <input id="email" name="email" type="text" value='{{ old("email") }}' placeholder='{{ __("Email address") }}' class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>
