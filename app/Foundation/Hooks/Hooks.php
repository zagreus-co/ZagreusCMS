...
class Hooks {
     ...
     *
     * @var App\Foundation\Hooks\Action
     */
    protected $action;
     ...
     *
     * @var App\Foundation\Hooks\Filter
     */
    protected $filter;
     ...
     */
    public function addAction($hook, $callback, $priority = 10, $arguments = 1)
    {
     ...
     * @param int    $arguments Number of arguments to accept
     */
    public function addFilter($hook, $callback, $priority = 10, $arguments = 1)
    {
